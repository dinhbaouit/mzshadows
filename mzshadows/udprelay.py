...
# mzshadows UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# mzshadows UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# mzshadows UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of mzshadows
# `remote`  means remote server of mzshadows
...
from mzshadows import encrypt, eventloop, lru_cache, common, shell
from mzshadows.common import parse_header, pack_addr, onetimeauth_verify, \
...
class UDPRelay(object):
    ...
    def _handle_server(self):
        ...
        if self._is_local:
            ...
            # spec https://mzshadows.org/en/spec/one-time-auth.html
