...
import getopt
import logging
from mzshadows.common import to_bytes, to_str, IPNetwork
from mzshadows import encrypt
...
def print_mzshadows():
    ...
    try:
        ...
        version = pkg_resources.get_distribution('mzshadows').version
    except Exception:
        pass
    print('mzshadows %s' % version)
...
def get_config(is_local):
    ...
    config['pid-file'] = config.get('pid-file', '/var/run/mzshadows.pid')
    config['log-file'] = config.get('log-file', '/var/log/mzshadows.log')
...
Online help: <https://github.com/mzshadows/mzshadows>
''')
